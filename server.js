// Local dev server — mirrors the Vercel api/ocr.js serverless function.
// For Vercel-based local dev, use: npx vercel dev
...
app.listen(PORT, () => {
  console.log(`Fleet KM Logger running at http://localhost:${PORT}`);
});
